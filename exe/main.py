...
def bullet_impact(player01, player02):
    for bullet in player01.bullets:
        if player02.x <= bullet.x <= player02.x + 38 and player02.y <= bullet.y <= (player02.y + 60):
            player02.is_dying = True
            player02.is_dead = True
    for bullet in player02.bullets:
        if player01.x <= bullet.x <= player01.x + 38 and player01.y <= bullet.y <= (player01.y + 60):
            player01.is_dying = True
            player01.is_dead = True
